...
var deployAction = function (glueStackPlugin) { return __awaiter(void 0, void 0, void 0, function () {
    var deploy, _a, _b, _c, plugin, e_1_1;
    var _d, e_1, _e, _f;
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 2:
                ...
                _a = true, _b = __asyncValues(deploy.plugins);
                _g.label = 3;
            ...
            case 5:
                _g.trys.push([5, , 7, 8]);
                plugin = _f;
                return [4, deploy.verifyPlugin(plugin, 'Dockerfile')];
            case 6:
                _g.sent();
                return [3, 8];
            case 7:
            ...
            case 14:
                ...
                return [7];
            case 15: return [7];
            case 16: return [4, deploy.createZip()];
            case 17:
                _g.sent();
                console.log('\n> Authenticating user credentials...');
                return [4, deploy.auth()];
            case 18:
                _g.sent();
